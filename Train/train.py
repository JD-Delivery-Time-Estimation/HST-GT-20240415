...
def continue_train(Recordpath,model_path,continue_epoch):
    # split train test
    N_train = int(240 * 0.8)
    N_test = int(240 * 0.2)
    ...
    cmask = cmask_ins
    dmask = downmask_ins
    print('Continue train form epoch {}'.format(continue_epoch))
    for epoch in range(continue_epoch,6200):
        ...
        if epoch % 2 == 0:
            with open(Recordpath + "continue_train_record.txt",'a+') as f:
                print("epoch: {}, loss_wh: {}, loss_pack: {}, loss_sort: {}, loss_all: {}, loss: {}".format(epoch,loss_whs/sn,loss_packs/sn,loss_sorts/sn,loss_alls/sn,losss/sn),file=f)
            with open(Recordpath + "continue_train_metric.txt","a+") as f:
                print(metric_all(pres,yts),file=f)
        if epoch % 10 == 0:
